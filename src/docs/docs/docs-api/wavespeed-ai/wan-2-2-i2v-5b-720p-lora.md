# /docs/docs-api/wavespeed-ai/wan-2.2-i2v-5b-720p-lora

来源: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.2-i2v-5b-720p-lora

[WaveSpeedAI API](/docs/docs-api/webhooks "WaveSpeedAI API")[Wavespeed AI](/docs/docs-api/wavespeed-ai/any-llm "Wavespeed AI")Wan 2.2 I2V 5b 720p LoRA
...
[Try it on WavespeedAI!](https://wavespeed.ai/models/wavespeed-ai/wan-2.2/i2v-5b-720p-lora)
...
# Submit the task
curl --location --request POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.2/i2v-5b-720p-lora" \
...
[Wan 2.2 I2V 5b 720p](/docs/docs-api/wavespeed-ai/wan-2.2-i2v-5b-720p "Wan 2.2 I2V 5b 720p")[Wan 2.2 I2V 720p](/docs/docs-api/wavespeed-ai/wan-2.2-i2v-720p "Wan 2.2 I2V 720p")
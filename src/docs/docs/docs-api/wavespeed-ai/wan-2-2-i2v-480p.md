# /docs/docs-api/wavespeed-ai/wan-2.2-i2v-480p

来源: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.2-i2v-480p

[WaveSpeedAI API](/docs/docs-api/webhooks "WaveSpeedAI API")[Wavespeed AI](/docs/docs-api/wavespeed-ai/any-llm "Wavespeed AI")Wan 2.2 I2V 480p
...
[Try it on WavespeedAI!](https://wavespeed.ai/models/wavespeed-ai/wan-2.2/i2v-480p)
...
# Submit the task
curl --location --request POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.2/i2v-480p" \
...
[Wan 2.2 Fun Control](/docs/docs-api/wavespeed-ai/wan-2.2-fun-control "Wan 2.2 Fun Control")[Wan 2.2 I2V 480p LoRA](/docs/docs-api/wavespeed-ai/wan-2.2-i2v-480p-lora "Wan 2.2 I2V 480p LoRA")
# /docs/docs-api/wavespeed-ai/wan-2.2-t2v-480p

来源: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.2-t2v-480p

[WaveSpeedAI API](/docs/docs-api/webhooks "WaveSpeedAI API")[Wavespeed AI](/docs/docs-api/wavespeed-ai/any-llm "Wavespeed AI")Wan 2.2 T2V 480p
...
[Try it on WavespeedAI!](https://wavespeed.ai/models/wavespeed-ai/wan-2.2/t2v-480p)
...
[Wan 2.2 Speech To Video](/docs/docs-api/wavespeed-ai/wan-2.2-speech-to-video "Wan 2.2 Speech To Video")[Wan 2.2 T2V 480p LoRA](/docs/docs-api/wavespeed-ai/wan-2.2-t2v-480p-lora "Wan 2.2 T2V 480p LoRA")
# /docs/docs-api/wavespeed-ai/wan-2.2-t2v-480p-lora

来源: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.2-t2v-480p-lora

[WaveSpeedAI API](/docs/docs-api/webhooks "WaveSpeedAI API")[Wavespeed AI](/docs/docs-api/wavespeed-ai/any-llm "Wavespeed AI")Wan 2.2 T2V 480p LoRA
...
[Try it on WavespeedAI!](https://wavespeed.ai/models/wavespeed-ai/wan-2.2/t2v-480p-lora)
...
[Wan 2.2 T2V 480p](/docs/docs-api/wavespeed-ai/wan-2.2-t2v-480p "Wan 2.2 T2V 480p")[Wan 2.2 T2V 480p LoRA Ultra Fast](/docs/docs-api/wavespeed-ai/wan-2.2-t2v-480p-lora-ultra-fast "Wan 2.2 T2V 480p LoRA Ultra Fast")
# /docs/docs-api/wavespeed-ai/wan-2.2-t2v-720p

来源: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.2-t2v-720p

[WaveSpeedAI API](/docs/docs-api/webhooks "WaveSpeedAI API")[Wavespeed AI](/docs/docs-api/wavespeed-ai/any-llm "Wavespeed AI")Wan 2.2 T2V 720p
...
[Try it on WavespeedAI!](https://wavespeed.ai/models/wavespeed-ai/wan-2.2/t2v-720p)
...
[Wan 2.2 T2V 5b 720p LoRA](/docs/docs-api/wavespeed-ai/wan-2.2-t2v-5b-720p-lora "Wan 2.2 T2V 5b 720p LoRA")[Wan 2.2 T2V 720p LoRA](/docs/docs-api/wavespeed-ai/wan-2.2-t2v-720p-lora "Wan 2.2 T2V 720p LoRA")
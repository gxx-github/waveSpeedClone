# /docs/docs-api/wavespeed-ai/wan-2.1-text-to-image-lora

来源: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.1-text-to-image-lora

[WaveSpeedAI API](/docs/docs-api/webhooks "WaveSpeedAI API")[Wavespeed AI](/docs/docs-api/wavespeed-ai/any-llm "Wavespeed AI")Wan 2.1 Text To Image LoRA
...
[Try it on WavespeedAI!](https://wavespeed.ai/models/wavespeed-ai/wan-2.1/text-to-image-lora)
...
[Wan 2.1 Text To Image](/docs/docs-api/wavespeed-ai/wan-2.1-text-to-image "Wan 2.1 Text To Image")[Wan 2.1 V2V 480p](/docs/docs-api/wavespeed-ai/wan-2.1-v2v-480p "Wan 2.1 V2V 480p")
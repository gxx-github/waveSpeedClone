# /docs/docs-api/bytedance/bytedance-seedance-v1-lite-t2v-1080p

来源: https://wavespeed.ai/docs/docs-api/bytedance/bytedance-seedance-v1-lite-t2v-1080p

[WaveSpeedAI API](/docs/docs-api/webhooks "WaveSpeedAI API")[Bytedance](/docs/docs-api/bytedance/bytedance-avatar-omni-human "Bytedance")Bytedance Seedance V1 Lite T2V 1080p
...
[Try it on WavespeedAI!](https://wavespeed.ai/models/bytedance/seedance-v1-lite-t2v-1080p)
...
[Bytedance Seedance V1 Lite Reference To Video](/docs/docs-api/bytedance/bytedance-seedance-v1-lite-reference-to-video "Bytedance Seedance V1 Lite Reference To Video")[Bytedance Seedance V1 Lite T2V 480p](/docs/docs-api/bytedance/bytedance-seedance-v1-lite-t2v-480p "Bytedance Seedance V1 Lite T2V 480p")
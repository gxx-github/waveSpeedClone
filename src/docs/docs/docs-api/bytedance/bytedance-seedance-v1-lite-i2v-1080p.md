# /docs/docs-api/bytedance/bytedance-seedance-v1-lite-i2v-1080p

来源: https://wavespeed.ai/docs/docs-api/bytedance/bytedance-seedance-v1-lite-i2v-1080p

[WaveSpeedAI API](/docs/docs-api/webhooks "WaveSpeedAI API")[Bytedance](/docs/docs-api/bytedance/bytedance-avatar-omni-human "Bytedance")Bytedance Seedance V1 Lite I2V 1080p
...
[Try it on WavespeedAI!](https://wavespeed.ai/models/bytedance/seedance-v1-lite-i2v-1080p)
...
Input image supports both URL and Base64 format; The image file size cannot exceed 30MB, and the image resolution should not be less than 300\*300px.
...
[Bytedance Portrait](/docs/docs-api/bytedance/bytedance-portrait "Bytedance Portrait")[Bytedance Seedance V1 Lite I2V 480p](/docs/docs-api/bytedance/bytedance-seedance-v1-lite-i2v-480p "Bytedance Seedance V1 Lite I2V 480p")